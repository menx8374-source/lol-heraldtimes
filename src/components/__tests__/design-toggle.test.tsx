...
describe("DesignToggle（拡張E14: 標準/ニュース記事風 セグメント切替）", () => {
  const html = renderToStaticMarkup(<DesignToggle />);

  it("「デザイン」ラベルと標準・ニュース記事風の2択セグメントを持ち、切替機能だと分かる", () => {
