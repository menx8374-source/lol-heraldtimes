...
export const SEO_SYSTEM_PROMPT =
  ...
  "seoTitleは共通ルールとして、重要語(パッチ番号・チャンピオン名・大会名・日付)を前半28〜32字以内に置き、" +
  "区切りには全角の｜・を使ってください(本文に無い事実・チャンピオン名は捏造しない)。" +
  "カテゴリに合う型を選んで適用してください。カテゴリ別の型の例: " +
  "パッチ/メタは「【LoL】パッチ{番号}変更点まとめ｜強化/弱体チャンピオン一覧」、" +
  "5chの反応・海外の反応は「【{ラベル}】{主題}｜{象徴的な一言/反応}」(既存の反応記事タイトルの雰囲気を尊重)、" +
  "Riot公式は「【LoL】{発表主題}｜公式まとめ」、" +
  "eスポーツは「【{大会名}】{節/結果}まとめ」、" +
  "チャンピオン/Tier系の話題があれば「【{チャンピオン名}】{ビルド/対策/カウンター等}｜パッチ{番号}」の型にしてください。" +
  "metaDescriptionも前半に検索されやすい語(パッチ番号・チャンピオン名等)を置くよう意識してください。" +
