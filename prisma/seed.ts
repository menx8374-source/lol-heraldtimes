...
const articles: SeedArticle[] = [
  ...
  },
  {
    ...
    body: body(
      ...
      {
        type: "quote",
        text: "壁飛び5連続でキャリーとか草生える",
        source: "5ch まとめ",
      },
      { type: "heading", text: "スレ民の反応" },
      {
        type: "paragraph",
  ...
  },
  {
    ...
    body: body(
      ...
      {
        type: "quote",
        text: "先週までゴミ扱いされてたチャンプが急にSランク入りしてて笑う",
        source: "海外フォーラム",
      },
